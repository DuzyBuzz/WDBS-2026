...
public sealed record AgingOfAccountsReportDocumentData(
    string ReportTitle,
...
internal sealed class AgingOfAccountsReportPrintHelper : IReportPreviewSource
{
    ...
    private readonly AgingOfAccountsReportDocumentData _document;
    ...
    public AgingOfAccountsReportPrintHelper(AgingOfAccountsReportDocumentData document)
    {
        _document = document;
    }
    ...
    private void ExportToExcelInternal(string filePath, IProgress<ReportOperationProgress>? progress, CancellationToken cancellationToken)
    {
        ...
        IXLWorksheet sheet = workbook.Worksheets.Add("Aging Report");
        ...
        if (definitions.Length > 0)
        {
            ...
            var table = tableRange.CreateTable("AgingReportTable");
    ...
    private static ColumnDefinition[] GetColumnDefinitions()
    {
        return
        [
            new("Account_No", "Account No.", 12F, StringAlignment.Center),
            new("Concessionaire_Name", "Concessionaire Name", 22F, StringAlignment.Near),
            new("Current", "Current", 9.5F, StringAlignment.Far),
            new("1-30_Days", "1-30 Days", 9.5F, StringAlignment.Far),
            new("31-60_Days", "31-60 Days", 9.5F, StringAlignment.Far),
            new("61-90_Days", "61-90 Days", 9.5F, StringAlignment.Far),
            new("91-120_Days", "91-120 Days", 9.5F, StringAlignment.Far),
            new("Over_120_Days", "Over 120 Days", 9.5F, StringAlignment.Far),
            new("Total", "Total", 10F, StringAlignment.Far)
        ];
    }
