...
internal sealed class PrintBillInvoice : IReportPreviewSource
{
    ...
    private void DrawLeftPanel(Graphics g, Rectangle rect)
    {
        ...
        g.DrawString(_document.PreviousReading.ToString(CultureInfo.InvariantCulture), _bodyBoldFont, Brushes.Black, new PointF(meterRect.Left + 35, headingBottom + 5));
        g.DrawString(_document.PresentReading.ToString(CultureInfo.InvariantCulture), _bodyBoldFont, Brushes.Black, new PointF(col1X + 35, headingBottom + 5));
        g.DrawString(_document.Consumption.ToString(CultureInfo.InvariantCulture), _bodyBoldFont, Brushes.Black, new PointF(col2X + 45, headingBottom + 5));
